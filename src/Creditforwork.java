import java.time.Duration;
    ...
    public class Creditforwork 
    {
        ...
        WebDriver driver;
        {
            ...
            driver.get("https://c4wprod--qa2021.sandbox.lightning.force.com/lightning/r/loan__Loan_Account__c/a1hD4000000lhWCIAY/view");
           ...
           /* driver.findElement(By.id("00ND400000ADHsBj_id0_j_id53_loanDetailIframe_chkbox")).click();
            driver.findElement(By.id("00ND400000ADHsBj_id0_j_id53_loanDetailIframe_chkbox")).click();
            driver.findElement(By.id("00ND400000ADHsBj_id0_j_id53_loanDetailIframe_chkbox")).click();
            driver.findElement(By.id("00ND400000ADHsBj_id0_j_id53_loanDetailIframe_chkbox")).click();
            driver.findElement(By.id("00ND400000ADHsBj_id0_j_id53_loanDetailIframe")).click();
            //driver.findElement(By.xpath("//*[@id=\"00ND400000ADHsBj_id0_j_id53_loanDetailIframe\"]/checkbox")).click();
          ...
          System.out.print("checkbox clicked");
            ...
            //WebElement element = driver.findElement(By.id("00ND400000ADHsBj_id0_j_id53_loanDetailIframe_ileinneredit"));
